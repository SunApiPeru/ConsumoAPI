...
mensaje_bienvenida = "Hola, bienvenido a este pequeño script sobre como realizar la búsqueda de uno o más contribuyentes por"+\
					 "su nombre o razón social que hayan sido dados de baja. Esperamos que te sea de utilidad en tus futuras implementaciones."+\
			  		 " Cualquier duda o inquietud no dudes en comunicarte con nuestro equipo utilizando el formulario de"+\
