...
# Api key utilizada para la API de pruebas
API_KEY = 'sunapi'

mensaje_bienvenida = "Hola, bienvenido a este pequeño demo sobre como obtener información de un contribuyente usando su RUC. Esperamos que "+\
